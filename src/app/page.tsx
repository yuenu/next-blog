...
function Info() {
  return (
    <div>
      ...
      <p>I am a front-end engineer, And eager to learn new web techniques.</p>
      <div
        id="soical"
        className={clsx(
...
function Heading(props: HeadingProps) {
  return <h2 className="text-2xl text-orange-400">{props.children}</h2>
}
      ...
      <div className="my-4">
        ...
        <ul className="my-6 flex list-disc flex-col gap-4 pl-5">
          ...
          <li>
            ...
            :Explore the world of culinary delights and discover your ultimate
            source of cooking inspiration
          </li>
        </ul>
      </div>
    </Main>
